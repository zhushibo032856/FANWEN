...
#import "ZZMediaHotCell.h"
#import "ZZHeadLinesCell.h"
@interface ZZMediaHotVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (UIImageView *)backImageView{
    if (!_backImageView) {
        ...
        _backImageView.image = [UIImage imageNamed:@"Erudite-5"];
    }
...
- (ZZBaseTableView *)tableView{
    ...
    if (!_tableView) {
        ...
        [_tableView registerClass:[ZZHeadLinesCell class] forCellReuseIdentifier:@"HeadLinesCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ZZHeadLinesCell *cell = [tableView dequeueReusableCellWithIdentifier:@"HeadLinesCell" forIndexPath:indexPath];
    [cell initCellWith];
    return cell;
}
